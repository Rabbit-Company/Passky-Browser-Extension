function displayPasswords(){
    ...
    if(sessionStorage.passwords !== null && typeof(sessionStorage.passwords) !== 'undefined'){
        ...
        for(let i = 0; i < passwords.length; i++){
            ...
            //Copy username
            html_passwords += "<a class='copy-username' href=\"javascript:copyToClipboard('" + passwords[i].username + "');\">";
            ...
            //Copy password
            html_passwords += "<a href=\"javascript:copyToClipboard('" + decrypted_password + "');\">";
            ...
            //Edit Password
            html_passwords += "<a href=\"javascript:changeDialog(4,'" + data + "'); show('dialog');\">";
            ...
            //Delete Password
            html_passwords += "<a href=\"javascript:changeDialog(6," + passwords[i].id + "); show('dialog');\">";
